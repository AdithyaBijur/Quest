...
class Share extends React.Component {
    ...
    render() {
        ...
        persons = (
            ...
            <div className="SHQues" style={{ width: 400, height: 280 }}>
                ...
                <form className='SHformdiv' noValidate autoComplete="off">
                    ...
                    <div style={{ width: 300, margin: 'auto', marginTop: 30 }}>
                        <input type="text" style={{ width: 250, height: 40, borderRadius: 20, outline: 'none', textIndent: 15 }} placeholder="please enter correct username" name="userShare" onChange={this.handleChange} required></input>
                    </div>
                    <br /><br />
                    <div className='SHsubmit' >
                        <Button variant="outline-primary" style={{ margin: 'auto', marginLeft: 160 }} onClick={this.shareAmongUsers} >Share</Button>
                    </div>
                </form>
            </div>
        )
