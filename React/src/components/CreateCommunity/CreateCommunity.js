                    ...
                    <div className="CreateFormDiv">
                        <form>
                            <div className="CCFORM">
                                ...
                                <Button className="add_but" style={butt} type="submit" onClick={this.addCommuHandler}><NavLink to="/" style={{ display: 'block', textDecoration: 'none', color: 'white' }}>CREATE</NavLink></Button><br /><br /><br />
                            </div>
                        </form>
                    </div>
                </div>
